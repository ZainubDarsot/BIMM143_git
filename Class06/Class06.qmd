...
We will grade a whole class of student assignments. We will always try to start with q wimplified version of the problem. 
...
Because this student has missing hw assigments, we have to omit the NA values from the df using the `na.rm=TRUE` function. 
